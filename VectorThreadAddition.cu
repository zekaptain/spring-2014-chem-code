/*author: Zeke Elkins
/date: 4/8/14
/description: adding vectors with threads in CUDA
*/
...
//each thread handles a different element of the array
...
int main(void) (
    ...
    //alloc space for host copies of a, b, c and setup input vals
